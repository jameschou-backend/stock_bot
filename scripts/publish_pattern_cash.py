...
import json
from scripts import research_pattern_cash as study
...
def publish(left,right,proof_path,publication_path):
    ...
    refs=file_identities([Path(__file__),ROOT/'skills/support_risk_source_audit.py',
                         ROOT/'skills/pattern_cache_audit.py'],ROOT)
    ...
    value=dict(report,schema='pattern_cash_publication_v1',adopted=False,strict_data_ready=False,
