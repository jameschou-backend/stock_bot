...
def render_research(status):
    ...
    from app.cash_allocation_research import render as render_cash_allocation
    from app.exit_research import render as render_exit
