...
**結論**：Label-10 在 2019-2021H1 期間（Folds 3-7）有真實 OOS alpha，但 2018 熊市和 2021H2 輪動期失敗。整體屬「存疑」等級，建議：
1. 擴展 Folds 至 2022-2024（當前只測 2018-2021）
2. 考慮在熊市 Folds 加大盤過濾（`market_filter_tiers`）
3. 在嚴格 WF 通過前不擴大實單規模
