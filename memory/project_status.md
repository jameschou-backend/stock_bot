...
| **嚴格 Walk-Forward（session 6）** | 🟠 存疑：5/8 Folds Sharpe>1.0；平均 Sharpe 1.518；2018 熊市和 2021H2 失敗 |

**核心發現**：Label-10（10日 label horizon 對齊 9日平均持倉）是最重要的單一改進。Rank Drop 比任何絕對指標更快捕捉弱化訊號。
...
| 項目 | 說明 | 預期效果 |
|------|------|----------|
| Walk-Forward 擴展至 2022-2024 | 當前 8 Folds 只測 2018-2021，需補後段驗證 | 確認 2022 熊市和 2024 大漲的 OOS 表現 |
