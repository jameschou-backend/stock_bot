...
> **現行 10y walk-forward 結果（Exp D，漸進大盤過濾+最少2檔，2026-03-15）**：
> 累積 **+2637.11%**、大盤 **+53.68%**、超額 **+2583.43%**、MDD **-29.20%**、
> Sharpe **+1.042**、Calmar **+1.367**、年化 **+39.92%**
> 期間：2016-05-03 ~ 2026-02-03，118 再平衡期，2009 筆交易，停損觸發 0 次
...
|------|------|---------|-----|--------|--------|------|
| **Exp D（生產）** | **漸進過濾+最少2檔** | **+2637%** | **-29%** | **1.042** | **1.367** | **← 現行生產** |
