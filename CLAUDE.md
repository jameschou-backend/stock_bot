...
現行 10y walk-forward 結果：累積 +1795%、Sharpe 1.009、MDD -29.3%（2026-03-18，最新 adj_close）。
...
> **現行 10y walk-forward 結果（2026-03-18，最新 adj_close，56 特徵）**：
> 累積 **+1795.24%**、大盤 **+54.58%**、超額 **+1740.66%**、MDD **-29.29%**、
> Sharpe **+1.009**、Calmar **+1.188**、年化 **+34.78%**
> 期間：2016-05-03 ~ 2026-02-05，2009 筆交易，停損觸發 0 次
> 配置：無停損 + 漸進大盤過濾（-5%:x0.5, -10%:x0.25, -15%:x0.10）+ 最少 2 檔
>
> ⚠️ **注意（2026-03-18）**：舊快照 Exp D +2637%（2026-03-15）因 adj_close 更新後不可重現，
> 現行正確基準為 +1795%（同樣無 lookahead bias，同樣 56 特徵）。
>
> 逐年報酬（現行基準，2026-03-18）：
> | 年份 | 策略 | 大盤 | 超額 |
> |------|------|------|------|
> | 2016 | +8.09% | +1.87% | +6.21% |
> | 2017 | +38.78% | +11.57% | +27.20% |
> | 2018 | -5.92% | -15.35% | +9.42% |
> | 2019 | +25.24% | +12.01% | +13.23% |
> | 2020 | +67.61% | +18.13% | +49.48% |
> | 2021 | +45.78% | +19.71% | +26.07% |
> | 2022 | +11.63% | -15.83% | +27.46% |
> | 2023 | +107.78% | +22.37% | +85.41% |
> | 2024 | +21.34% | +2.99% | +18.36% |
> | 2025 | +28.68% | -5.69% | +34.37% |
> | 2026 | +21.19% | +1.37% | +19.81% |
>
...
|------|------|---------|-----|--------|--------|------|
| **現行基準（2026-03-18）** | **漸進過濾+最少2檔** | **+1795%** | **-29%** | **1.009** | **1.188** | **← 現行生產** |
