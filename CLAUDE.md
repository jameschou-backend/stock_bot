...
> **現行 10y walk-forward 結果（buffer 交易日制 + 含下市股去偏後，2026-06-22，topn=30）**：
> 累積 **+1507.78%**、大盤 **+65.71%**、超額 **+1442.07%**、MDD **-31.78%**、
> Sharpe **1.06**、Calmar **1.02**、年化 **+32.56%**
> 勝率 46.40%、盈虧比 1.84、交易次數 3028、期間 2016-07-11 ~ 2026-05-19
> 配置：topn=30 + 無停損 + 漸進大盤過濾 + 最少 2 檔 + 流動性加權 + SHAP剪枝 + buffer 交易日制 + 含下市股
>
> ✅ **survivorship 已修正（2026-06-22 回補 2016-2021 下市股 ~5.13M 列）**：
> 累積 +1141%→**+1508%**、Sharpe 0.99→**1.06**、MDD -34.46%→**-31.78%**（三項全改善）。
> **績效反升而非下降**：台股下市以併購溢價為主（非破產）+ clip -50% 限制地雷股損失 +
> 模型籌碼特徵傾向迴避惡化股 → 增強「alpha 非 survivorship 假象」的可信度。
> ⏳ 殘餘偏差：T 日收盤成交盤後籌碼（point-in-time）、adj_close 未還原，絕對績效仍略高估。
>
> **前一基準（buffer 交易日制 / 無下市股，2026-06-17）**：+1140.68%、Sharpe 0.994、MDD -34.46%
>
